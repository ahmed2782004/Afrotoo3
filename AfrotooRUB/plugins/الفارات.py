...
async def variable(event):
    ...
    if input_str == "1":
        variable = "DEFAULT_PIC"
        zinfo = "AfrotooUB/helpers/styles/jepthon.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "AfrotooUB/helpers/styles/Starjedi.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "AfrotooUB/helpers/styles/Papernotes.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "AfrotooUB/helpers/styles/Terserah.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "AfrotooUB/helpers/styles/Photography Signature.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "AfrotooUB/helpers/styles/Austein.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "AfrotooUB/helpers/styles/Dream MMA.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "AfrotooUB/helpers/styles/EASPORTS15.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "AfrotooUB/helpers/styles/KGMissKindergarten.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "AfrotooUB/helpers/styles/212 Orion Sans PERSONAL USE.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "AfrotooUB/helpers/styles/PEPSI_pl.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "AfrotooUB/helpers/styles/Paskowy.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "AfrotooUB/helpers/styles/Cream Cake.otf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "AfrotooUB/helpers/styles/Hello Valentina.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "AfrotooUB/helpers/styles/Alien-Encounters-Regular.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
        ...
        variable = "DEFAULT_PIC"
        zinfo = "AfrotooUB/helpers/styles/Linebeam.ttf"
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await jep.edit("**⌔∮ تم بنجاح تغيير زخرفة الصورة الوقتية\n\n❃ جار اعادة تشغيل السورس انتظر من 2-5 دقائق ليتشغل مره اخرى**".format(input_str))
        else:
...
DevJoker = [5904216848, 5904216848]
