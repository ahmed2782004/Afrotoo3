...
from AfrotooUB import BOTLOG_CHATID
...
autopic_path = os.path.join(os.getcwd(), "AfrotooUB", "original_pic.png")
digitalpic_path = os.path.join(os.getcwd(), "AfrotooUB", "digital_pic.png")
digital_group_pic_path = os.path.join(os.getcwd(), "AfrotooUB", "digital_group_pic.png")
autophoto_path = os.path.join(os.getcwd(), "AfrotooUB", "photo_pfp.png")
auto_group_photo_path = os.path.join(os.getcwd(), "AfrotooUB", "photo_pfp.png")
