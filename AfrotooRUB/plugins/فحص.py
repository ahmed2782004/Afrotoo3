...
from AfrotooUB import StartTime, l313l, JEPVERSION
...
async def amireallyalive(event):
    ...
    mention = first_name
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "**父[ afrotoo 𝙸𝚂 𝚆𝙾𝚁𝙺𝙸𝙽𝙶 ✓ ](t.me/soursafrotoo)父**"
    ...
    try:
        ...
        pass
    if HuRe_IMG:
        AfrotooUB = [x for x in HuRe_IMG.split()]
