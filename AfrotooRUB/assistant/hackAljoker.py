...
'''
mm = '''
قم بلأنضمام الى قناة عفرتو @soursafrotoo
'''
...
keyboard = [
  ...
  [
    Button.url("سورس عفرتو 🤡", "https://t.me/soursafrotoo")
    ]
]
  ...
  if event.sender_id == bot.uid:
      async with bot.conversation(event.chat_id) as x:
        keyboard = [
          ...
          [
            Button.url("المطور", "https://t.me/soursafrotoo")
            ]
        ]
